...
<input type="text" placeholder="ادخل اسم  المكتبة  " class="form-control" name="lib"><br>
<br>
...
{$num=rand(1,1000000);
  ...
  $r1=mysqli_query($con,"insert into numbers(num,library,dob)
  values('$num','$library','$dt')");
