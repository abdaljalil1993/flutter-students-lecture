...
<div class="container">
		...
		<div class="row">
			...
			<div class="panel-heading">
				<h1 class="text-center text-uppercase">اضافة   فيديو    </h1>
			</div>

			<div class="panel-body">
		<form action="addvideo.php" method="post" enctype="multipart/form-data">
			<input type="text" placeholder="ادخل اسم  الفيديو  " class="form-control" name="n"><br>
...
if(isset($_POST['bt']))
{
move_uploaded_file($book,"videos/$bookname");

	$result=mysqli_query($con,"insert into 
	videos(name,de,videoname)
